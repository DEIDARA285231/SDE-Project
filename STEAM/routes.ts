 ...
 * @description - Returns the price for a certain game on the Steam store
 ...
 * @description - Returns the exact number of players for a certain game on the Steam store
 * @group Steam - Endpoints regarding the Steam store
 * @param {BigInteger} id.query - ID of the game we need to search
